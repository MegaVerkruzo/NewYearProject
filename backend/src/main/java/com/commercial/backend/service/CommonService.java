...
import com.commercial.backend.db.TreeStateRepository;
...
public class CommonService {
    ...
    public TreeState getTreeState(int activeGifts) {
        return treeStateRepository.findTreeStateByActiveGiftsCount(activeGifts).orElseGet(() -> {
            logger.error("GET TREE STATE IS EMPTY, CHECK THIS SITUTATION");
